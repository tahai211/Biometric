...
@Component({
  selector: 'app-cardrenewextend-detail',
  templateUrl: './cardrenewextend-detail.component.html',
  styleUrl: './cardrenewextend-detail.component.scss'
})
export class CardrenewExtendDetailComponent implements OnInit {
  ...
  loadDataDetail() {
    ...
    const apiCall = this.selectedCardType == 'debit'
      ? this.svcardService.getCardReNewExtendDetail(req)
      : this.svcardService.getCardCreditReNewExtendDetail(req);
  ...
  create() {
    ...
    console.log('req: ', req);
    const apiCall = this.selectedCardType == 'debit'
      ? this.svcardService.createCardReNewExtend(req)
      : this.svcardService.createCardCreditReNewExtend(reqCredit);
  ...
  auth() {
    ...
    console.log('req: ', req);
    const apiCall = this.selectedCardType == 'debit'
      ? this.svcardService.authCardReNewExtend(req)
      : this.svcardService.authCardCreditReNewExtend(req);
  ...
  reject() {
    ...
    console.log('req: ', req);
    const apiCall = this.selectedCardType == 'debit'
      ? this.svcardService.rejectCardReNewExtend(req)
      : this.svcardService.rejectCardCreditReNewExtend(req);
  ...
  cancel() {
    ...
    console.log('req: ', req);
    const apiCall = this.selectedCardType == 'debit'
      ? this.svcardService.cancelCardReNewExtend(req)
      : this.svcardService.cancelCardCreditReNewExtend(req);
