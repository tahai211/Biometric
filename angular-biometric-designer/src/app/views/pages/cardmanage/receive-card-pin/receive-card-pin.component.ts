...
@Component({
  selector: 'app-receive-card-pin',
  templateUrl: './receive-card-pin.component.html',
  styleUrl: './receive-card-pin.component.scss'
})
export class ReceiveCardPinComponent {
  ...
  columns: Array<dxDataGridColumn | string> = [
    ...
    cancelStatusCard() {
      ...
      console.log('req_cancel: ', req_cancel)

      this.cardService.cancelStatusCard(req_cancel).subscribe(
        (response: any) => {
          console.log(new Date() + ": ", response);
